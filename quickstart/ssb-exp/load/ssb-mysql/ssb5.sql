drop database if exists ssb5;
create database ssb5;
use ssb5;
create table part (
    p_partkey bigint,
    p_name varchar(30),
...
set autocommit =0;
load data concurrent local infile 'ssbdata/data5/part.tbl'      into table part      fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data5/supplier.tbl'  into table supplier  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data5/customer.tbl'  into table customer  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data5/date.tbl'  into table date  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data5/lineorder.tbl'  into table lineorder  fields terminated by '|' lines terminated by '\n';
set autocommit =1;
