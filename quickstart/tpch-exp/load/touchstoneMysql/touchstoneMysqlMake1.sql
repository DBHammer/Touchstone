DROP DATABASE IF EXISTS TouchstoneTPCH1;
CREATE DATABASE TouchstoneTPCH1;
USE TouchstoneTPCH1;
...
load data concurrent local infile 'tstpchdata/data1/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data1/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
