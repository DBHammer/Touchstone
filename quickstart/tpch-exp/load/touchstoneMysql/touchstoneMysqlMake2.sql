DROP DATABASE IF EXISTS TouchstoneTPCH2;
CREATE DATABASE TouchstoneTPCH2;
USE TouchstoneTPCH2;
...
load data concurrent local infile 'tstpchdata/data2/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data2/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
