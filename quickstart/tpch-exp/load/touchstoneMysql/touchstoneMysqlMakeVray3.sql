DROP DATABASE IF EXISTS TouchstoneTPCH1L3;
CREATE DATABASE TouchstoneTPCH1L3;
USE TouchstoneTPCH1L3;
...
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL3/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
