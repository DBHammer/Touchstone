...
load data concurrent local infile 'ssbdata/data1/part.tbl'      into table part      fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data1/supplier.tbl'  into table supplier  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data1/customer.tbl'  into table customer  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data1/date.tbl'  into table date  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data1/lineorder.tbl'  into table lineorder  fields terminated by '|' lines terminated by '\n';
