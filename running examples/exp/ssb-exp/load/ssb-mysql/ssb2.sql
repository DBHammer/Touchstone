...
load data concurrent local infile 'ssbdata/data2/part.tbl'      into table part      fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data2/supplier.tbl'  into table supplier  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data2/customer.tbl'  into table customer  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data2/date.tbl'  into table date  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data2/lineorder.tbl'  into table lineorder  fields terminated by '|' lines terminated by '\n';SET FOREIGN_KEY_CHECKS=1;
