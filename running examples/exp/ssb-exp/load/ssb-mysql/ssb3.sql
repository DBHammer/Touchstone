drop database if exists ssb3;
create database ssb3;
use ssb3;
create table part (
    p_partkey bigint,
    p_name varchar(30),
...
load data concurrent local infile 'ssbdata/data3/part.tbl'      into table part      fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data3/supplier.tbl'  into table supplier  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data3/customer.tbl'  into table customer  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data3/date.tbl'  into table date  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data3/lineorder.tbl'  into table lineorder  fields terminated by '|' lines terminated by '\n';SET FOREIGN_KEY_CHECKS=1;
