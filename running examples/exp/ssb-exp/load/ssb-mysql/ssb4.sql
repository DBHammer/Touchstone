drop database if exists ssb4;
create database ssb4;
use ssb4;
create table part (
    p_partkey bigint,
    p_name varchar(30),
...
load data concurrent local infile 'ssbdata/data4/part.tbl'      into table part      fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data4/supplier.tbl'  into table supplier  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data4/customer.tbl'  into table customer  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data4/date.tbl'  into table date  fields terminated by '|' lines terminated by '\n';
load data concurrent local infile 'ssbdata/data4/lineorder.tbl'  into table lineorder  fields terminated by '|' lines terminated by '\n';SET FOREIGN_KEY_CHECKS=1;
