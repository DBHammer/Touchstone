DROP DATABASE IF EXISTS TPCHRM;
CREATE DATABASE TPCHRM;
USE TPCHRM;
...
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/customer.tbl.r' into table customer
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/lineitem.tbl.r' into table lineitem
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/nation.tbl.r' into table nation
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/orders.tbl.r' into table orders
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/partsupp.tbl.r' into table partsupp
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/part.tbl.r' into table part
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/region.tbl.r' into table region
fields terminated by '|' lines terminated by '|\n';
load data local infile '/mnt/shared/tpch/dbgen/build/datarandom/supplier.tbl.r' into table supplier
fields terminated by '|' lines terminated by '|\n';
