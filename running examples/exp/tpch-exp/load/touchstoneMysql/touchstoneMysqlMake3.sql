DROP DATABASE IF EXISTS TouchstoneTPCH3;
CREATE DATABASE TouchstoneTPCH3;
USE TouchstoneTPCH3;
...
load data concurrent local infile 'tstpchdata/data3/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data3/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
