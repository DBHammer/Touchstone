DROP DATABASE IF EXISTS TouchstoneTPCH4;
CREATE DATABASE TouchstoneTPCH4;
USE TouchstoneTPCH4;
...
load data concurrent local infile 'tstpchdata/data4/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile 'tstpchdata/data4/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
