DROP DATABASE IF EXISTS TouchstoneTPCH1L5;
CREATE DATABASE TouchstoneTPCH1L5;
USE TouchstoneTPCH1L5;
...
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/customer.tbl' into table customer
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/lineitem.tbl' into table lineitem
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/nation.tbl' into table nation
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/orders.tbl' into table orders
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/partsupp.tbl' into table partsupp
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/part.tbl' into table part
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/region.tbl' into table region
fields terminated by ',' lines terminated by '\n';
load data concurrent local infile '/home/wangqingshuai/Touchstone/old-bin/varyL/dataL5/supplier.tbl' into table supplier
fields terminated by ',' lines terminated by '\n';
